defmodule ScenicLiveReloadDemo.Component.Nav do
  ...
  def init(current_scene, opts) do
    ...
    graph =
      ...
      |> dropdown(
        {[
           {"Sensor", ScenicLiveReloadDemo.Scene.Sensor},
           {"Sensor (spec)", ScenicLiveReloadDemo.Scene.SensorSpec},
           {"Primitives", ScenicLiveReloadDemo.Scene.Primitives},
           {"Components", ScenicLiveReloadDemo.Scene.Components},
           {"Transforms", ScenicLiveReloadDemo.Scene.Transforms}
         ], current_scene},
        id: :nav,
        translate: {70, 15}
      )
