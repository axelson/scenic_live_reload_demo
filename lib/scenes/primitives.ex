defmodule ScenicLiveReloadDemo.Scene.Primitives do
  @moduledoc """
  Sample scene.
  """
  ...
  alias ScenicLiveReloadDemo.Component.Nav
  alias ScenicLiveReloadDemo.Component.Notes
  ...
  @bird_path :code.priv_dir(:scenic_live_reload_demo)
